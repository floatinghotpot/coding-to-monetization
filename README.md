...
既然是谈赚钱，像外包这种方式，把有限的生命折算成manhour来卖钱，可能过于苦逼，我们暂不讨论。

考虑到人力、时间、成本等因素，我们也暂时不讨论运营级、或者企业级的大型系统。大型系统的研发周期长、投入大、需求的复杂度，也超过个人和小团队的掌控。
...
而在上海，一个 5年经验的、技术能力还不错的程序员，薪资大约也就 15,000 左右。如果你做的 APP，每天能够有 1万个用户使用，基本上产生的广告收益和现金流，就可以达到一个程序员的工资水平。
